...
@section('title','Register user | Cars For You')

@section('h1','Register user')
        ...
        <div class="widget-content nopadding">
            <form action="{{ route('users.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="userForm">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="span5" placeholder="Name completo" name="name" id="name" required/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Email:</label>
                    <div class="controls">
                        <input type="email" class="span5" placeholder="email@email.com.br" name="email" id="email" required/>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Password:</label>
                    <div class="controls">
                        <input type="password" class="span5" placeholder="Password" name="password" id="password" required/>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions text-left ">
                    <a class="btn btn-danger" id="Back" href="{{ route('users.index') }}"> Back</a>
                    <button type="submit" id="Adicionar" class="btn btn-success">Add</button>
